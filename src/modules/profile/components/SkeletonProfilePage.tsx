	...
	return (
		<div className='max-w-6xl w-full h-full py-12 px-4'>
			<div className='flex flex-row gap-8 h-full w-full'>
				...
				<Card className='max-w-sm w-full h-[420px]'>
					<CardHeader>
					...
					<CardContent className='space-y-4'>
						...
						<div className='flex items-center gap-3'>
							...
							<div className='space-y-2'>
								...
								<Skeleton className='h-3 w-48' /> {/* Email value */}
							</div>
						</div>
						...
						<div className='flex items-center gap-3'>
							...
							<div className='space-y-2'>
								...
								<Skeleton className='h-3 w-36' /> {/* Affiliation value */}
							</div>
						</div>
						...
						<div className='flex items-center gap-3'>
							...
							<div className='space-y-2'>
								...
								<Skeleton className='h-3 w-24' /> {/* Nationality value */}
							</div>
						</div>
						...
						<div className='flex items-center gap-3'>
							...
							<div className='space-y-2'>
								...
								<Skeleton className='h-3 w-16' /> {/* Enabled/Disabled value */}
							</div>
						</div>
					</CardContent>
				</Card>
